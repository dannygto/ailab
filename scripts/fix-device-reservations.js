...
// 修复 DeviceReservations.tsx
const filePath = path.join(__dirname, '../frontend/src/components/devices/DeviceReservations.tsx');
...
try {
    ...
    console.log('修复了DeviceReservations.tsx');
    
} catch (error) {
    console.error('修复DeviceReservations.tsx时出错:', error);
}
