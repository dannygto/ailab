...
import { ExpandMoreIcon as ExpandMoreIcon, CheckIcon as CheckIconIcon, ErrorIcon as ErrorIcon, InfoIcon as InfoIcon, SecurityIcon as SecurityIcon } from '../../utils/icons';
...
const AIModelsettings: React.FC = () => {
  ...
  const testConnection = async () => {
    ...
    try {
      ...
      console.log('?? 开始测试AI连接:', config.selectedModel);
          ...
          <Grid item xs={12} lg={8}>
            <Card>
              <CardContent>
                ...
                {selectedModel && (
                  <div sx={{ mt: 2, p: 2, bgcolor: 'background.default', borderRadius: 1 }}>
                    ...
                    <div sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', mb: 2 }}>
