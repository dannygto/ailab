...
import { PlayArrowIcon as PlayIcon, RefreshIcon as RefreshIcon, DataUsageIcon as DataUsageIcon, analytics as AnalyticsIcon, CloudIcon as AccountCircleIcon, ErrorIcon as ErrorIcon, WarningIcon as WarningIcon } from '../../utils/icons';
            ...
            <Grid container spacing={2}>
              {dataSources.map((source) => (
                <Grid item xs={12} md={6} lg={4} key={source.id}>
                  <Card>
                    <CardContent>
                      <div display="flex" justifyContent="space-between" alignItems="start" mb={1}>
