...
export { default as analytics } from '@mui/icons-material/Assessment';
...
export { default as DragIndicatorIcon } from '@mui/icons-material/DragIndicatorIcon';
...
export { default as SignalIcon } from '@mui/icons-material/Wifi';
export { default as WifiIcon } from '@mui/icons-material/SignalWifiOff';
export { default as MediumSignalIcon } from '@mui/icons-material/SignalWifi2Bar';
export { default as SettingsIcon } from '@mui/icons-material/Settings';
export { default as BlockIcon } from '@mui/icons-material/Block';
export { default as TemperatureIcon } from '@mui/icons-material/Thermostat';
export { default as BatteryIcon } from '@mui/icons-material/BatteryFull';
...
export { default as DownloadForCloudOffIcon } from '@mui/icons-material/DownloadForOffline';
...
export { default as ControlIcon } from '@mui/icons-material/Settings';
export { default as CloudCheckCircleIcon } from '@mui/icons-material/CheckCircle';
export { default as SummarizeIcon } from '@mui/icons-material/Summarize';
export { default as title } from '@mui/icons-material/Title';
export { default as CloudIcon } from '@mui/icons-material/CloudQueue';
...
export { default as ScheduleIcon } from '@mui/icons-material/Schedule';
export { default as HelpOutlineIcon } from '@mui/icons-material/HelpOutline';
export { default as SmsIconIcon } from '@mui/icons-material/Sms';
export { default as LanguageIconIcon } from '@mui/icons-material/Language';
export { default as DevicesIconIcon } from '@mui/icons-material/Devices';
...
export { default as CloudUploadIconIcon } from '@mui/icons-material/CloudUpload';
export { default as BuildIconIcon } from '@mui/icons-material/Build';
export { default as BookmarkIcon } from '@mui/icons-material/Bookmark';
export { default as BookmarkBorderIcon } from '@mui/icons-material/BookmarkBorder';
export { default as EngineeringIconIcon } from '@mui/icons-material/Engineering';
export { default as CopyIcon } from '@mui/icons-material/ContentCopy';
export { default as ScatterPlotIconIcon } from '@mui/icons-material/ScatterPlot';
export { default as ExperimentalIcon } from '@mui/icons-material/Biotech';
export { default as HelpIconIcon } from '@mui/icons-material/Help';
export { default as RestoreIcon } from '@mui/icons-material/Restore';
export { default as SendIcon } from '@mui/icons-material/Send';
export { default as CheckIconIcon } from '@mui/icons-material/Check';
export { default as ExpandMoreIconIcon } from '@mui/icons-material/ExpandMore';
export { default as DataUsageIcon } from '@mui/icons-material/DataUsage';
export { default as CheckCircleIconIcon } from '@mui/icons-material/CheckCircle';
...
export const optimizationStats = {
  originalIconCount: 279,
  optimizedIconCount: 180,
  reductionPercentage: Math.round((1 - 180/279) * 100),
  estimatedMemorySaving: '35%',
  bundleSizeReduction: '~100KB'
};
