...
import { SignalCellular4BarIcon } from '../../../utils/icons';
import { SignalCellularAltIcon } from '../../../utils/icons';
import { SignalCellularAlt1BarIcon } from '../../../utils/icons';
import { SignalCellularConnectedNoInternet0BarIcon } from '../../../utils/icons';
  ...
  const renderData = () => {
    ...
    return (
      <div>
        ...
        {/* ͼ������ */}
        <div sx={{ mb: 4, height: 300, width: '100%' }}>
          {/* ������Լ���ͼ���������recharts��visx�� */}
          ...
          <div sx={{ 
            ...
            {/* ����ͼ��չʾ */}
            <div sx={{ display: 'flex', height: '100%', alignItems: 'flex-end', justifyContent: 'space-between' }}>
              {formattedData.slice(-12).map((data, index) => (
                <div key={index} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '8%' }}>
                  <div 
                    sx={{ 
                      width: '100%', 
