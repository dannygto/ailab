...
import { RefreshIcon as RefreshIcon, DownloadIcon as DownloadIcon, ZoomInIcon as ZoomInIcon, ZoomOutIcon as ZoomOutIcon } from '../../../utils/icons';
import {
  LineChart,
  Line,
  XAxis,
...
const DeviceMetricsChart: React.FC<DeviceMetricsChartProps> = ({
      ...
      return (
        <Card sx={{ 
          ...
          {payload.map((entry: any) => (
            <div key={entry.name} sx={{ display: 'flex', alignItems: 'center', my: 0.5 }}>
              <div sx={{ 
                width: 12, 
                height: 12, 
                mr: 1, 
  ...
  return (
    <Card className={className} style={style}>
      ...
      <div sx={{ py: 1, px: 2, display: 'flex', justifyContent: 'space-between' }}>
