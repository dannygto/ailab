...
import { PlayArrowIcon, StopIcon, PauseIcon, settings, PowerSettingsNewIcon as Powersettings, SpeedIcon, ThermostatAutoIcon, WaterDropIcon, ElectricBoltIcon, RefreshIcon } from '../../utils/icons';
          ...
          <Card>
            <CardContent>
              ...
              {commandHistory.length === 0 ? (
                ...
                <div sx={{ maxHeight: 200, overflow: 'auto' }}>
