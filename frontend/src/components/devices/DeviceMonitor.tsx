...
import { RefreshIcon as RefreshIcon, PlayArrowIcon as PlayArrowIcon, PauseIcon as PauseIcon, MoreVertIcon as MoreVertIcon, WarningIcon as WarningIcon, InfoIcon as InfoIcon, DownloadIcon as DownloadIcon, TuneIcon as TuneIcon, CodeIcon as CodeIcon, NotificationsActiveIcon as NotificationsActiveIcon } from '../../utils/icons';
...
const DeviceMonitor: React.FC<DeviceMonitorProps> = ({ 
  devices,
  wsEndpoint = 'ws://localhost:3002/ws' 
}) => {
  ...
  const exportAsCSV = () => {
    ...
    link.style.VisibilityIcon= 'hidden';
