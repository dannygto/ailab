...
import { ScienceIcon as ScienceIcon, PsychologyIcon as PsychologyIcon, ComputerIcon as ComputerIcon, ExpandMoreIcon as ExpandMoreIcon, WarningIcon as WarningIcon, GroupIcon as GroupIcon, ScheduleIcon as ScheduleIcon, SchoolIcon as SchoolIcon } from '../utils/icons';
...
const K12ExperimentManager: React.FC<K12ExperimentManagerProps> = ({
  ...
  if (loading) {
    return (
      <div display="flex" justifyContent="center" alignItems="center" minHeight="200px">
  ...
  return (
    <div>
      ...
      <div mb={2}>
        <Typography variant="body2" color="text.secondary">
          �ҵ� {filteredResults.length} ��ʵ�飬�ܹ� {experiments.length} ��K12ʵ����Դ
        </Typography>
      </div>
