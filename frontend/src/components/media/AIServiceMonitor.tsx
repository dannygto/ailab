...
import { CloudIcon as CloudIcon, ErrorIcon as ErrorIcon, CheckCircleIcon as SuccessIcon, WarningIcon as WarningIcon, RefreshIcon as RefreshIcon, TrendingUpIcon as TrendingUpIcon, TrendingDownIcon as TrendingDownIcon } from '../../utils/icons';
      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        {performanceMetrics.map((metric, index) => (
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card>
              <CardContent>
                <div sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1 }}>
