...
import { SearchIcon as SearchIcon, DownloadIcon as DownloadIcon, ArrowDownwardIcon as ScrollDownIcon, FilterListIcon as FilterIcon } from '../../utils/icons';
      ...
      >
        {filteredLogs.length > 0 ? (
          filteredLogs.map((log, index) => (
            <div key={index} sx={{ mb: 0.5, display: 'flex', alignItems: 'flex-start' }}>
              <Typography 
                variant="caption" 
                component="span" 
                sx={{ 
