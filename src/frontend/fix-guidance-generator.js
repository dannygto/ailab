...
console.log('开始修复 GuidanceGenerator.tsx...');

const filePath = path.join(__dirname, 'src/components/guidance/GuidanceGenerator.tsx');
...
try {
  ...
  console.log('✓ GuidanceGenerator.tsx 修复完成');
} catch (error) {
