...
console.log('开始修复 ExperimentTypeSelect.tsx...');

const filePath = path.join(__dirname, 'src/components/domain/experiments/ExperimentTypeSelect.tsx');
...
try {
  ...
  console.log('✓ ExperimentTypeSelect.tsx 修复完成');
} catch (error) {
