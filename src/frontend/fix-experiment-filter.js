...
console.log('开始修复 ExperimentFilterV2.tsx...');

const filePath = path.join(__dirname, 'src', 'components', 'domain', 'experiments', 'ExperimentFilterV2.tsx');

const fixedContent = `import React, { useState, useCallback } from 'react';
import {
  Box,
  Card,
  CardContent,
...
console.log('✓ ExperimentFilterV2.tsx 修复完成');
