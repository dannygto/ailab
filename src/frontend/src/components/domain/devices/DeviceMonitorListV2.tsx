    ...
    try {
      ...
      for (let i = 2; i <= 50; i++) {
        ...
        mockdevices.push({
          ...
          type: type,
          model: `Model-${1000 + i}`,
          manufacturer: ['科技公司A', '科技公司B', '科技公司C'][i % 3],
          description: `设备 ${i} 的详细信息`,
          status: deviceStatus,
          connectionStatus: status,
          location: `实验室 ${String.fromCharCode(65 + (i % 10))}`,
          lastSeen: new Date(2025, 0, Math.floor(Math.random() * 30) + 1),
          ...
          capabilities: ['基础监控', '数据传输', '远程控制'].slice(0, Math.floor(Math.random() * 3) + 1),
