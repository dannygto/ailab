...
const device_model_js_1 = require("../models/device.model.js");
    ...
    const sampleDevices = [
        {
            id: 'dev-001',
            name: '数字显微镜-A1',
            type: device_model_js_1.DeviceType.MICROSCOPE,
            model: 'DigitalScope X500',
            manufacturer: '光科技器材有限公司',
            description: '高精度数字显微镜，支持远程控制和实时图像传输',
            connectionStatus: device_model_js_1.DeviceConnectionStatus.ONLINE,
            location: '实验室A-101',
        ...
        },
        {
            id: 'dev-002',
            name: '多功能数据采集器-S2',
            type: device_model_js_1.DeviceType.DATALOGGER,
        ...
        },
        {
            id: 'dev-003',
            name: '光谱分析仪-P5',
            type: device_model_js_1.DeviceType.SPECTROSCOPE,
            model: 'SpectrumMaster 2000',
            manufacturer: '精密仪器研究院',
            description: '高精度光谱分析仪，可用于物质成分分析和光学实验',
            connectionStatus: device_model_js_1.DeviceConnectionStatus.MAINTENANCE,
            location: '实验室C-305',
    ...
    constructor() {
        ...
        this.updateDeviceStatus = (req, res) => {
            try {
                ...
                if (!status || !Object.values(device_model_js_1.DeviceConnectionStatus).includes(status)) {
        ...
        this.sendCommand = (req, res) => {
            try {
                ...
                if (device.connectionStatus !== device_model_js_1.DeviceConnectionStatus.ONLINE) {
                    return res.status(400).json({
                        success: false,
        ...
        this.createSession = (req, res) => {
            try {
                ...
                if (device.type === device_model_js_1.DeviceType.MICROSCOPE) {
