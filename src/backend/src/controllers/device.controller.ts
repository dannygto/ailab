...
const deviceReservations: Map<string, DeviceReservation> = new Map();
const deviceDataPoints: Map<string, DeviceDataPoint[]> = new Map();
const deviceCommands: Map<string, DeviceCommand[]> = new Map();
