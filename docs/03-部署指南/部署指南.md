...
本文档详细介绍了人工智能实验平台的部署流程，包括开发环境、测试环境和生产环境的部署方法。umentation\03-deployment\deployment-guide.md] 的中文链接
...
鏈枃妗ｈ缁嗕粙缁嶄簡人工智能实验平台鐨勯儴缃叉祦绋嬶紝鍖呮嫭开发环境冦€佹祴璇曠幆澧冨拰鐢熶骇鐜鐨勯儴缃叉柟娉曘€?

## 馃殌 开发环境冨揩閫熷惎鍔?

### Windows开发环境?(褰撳墠鎺ㄨ崘鏂瑰紡)
...
- **鍚庣鍋ュ悍妫€鏌?*: http://localhost:3001/api/health  
- **鍚庣鏁版嵁鎺ュ彛**: http://localhost:3001/api/dashboard/stats
