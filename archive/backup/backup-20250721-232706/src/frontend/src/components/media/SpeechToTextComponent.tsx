...
import { SpeechToTextResponse } from '../../types/mediaTypes';
...
const SpeechToTextComponent: React.FC<SpeechToTextComponentProps> = ({ 
  ...
  const processAudio = async () => {
    ...
    try {
      ...
      const mockResult: SpeechToTextResponse = {
        text: '这是一个示例转录结果。',
        confidence: 0.95,
        segments: [
          { start: 0, end: 2.5, text: '这是一个', confidence: 0.96 },
          { start: 2.5, end: 5.0, text: '示例转录结果。', confidence: 0.94 }
        ],
        metadata: {
          duration: 5.0,
          wordCount: 7,
