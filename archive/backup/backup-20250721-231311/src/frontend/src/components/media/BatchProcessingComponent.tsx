...
import { CloudCheckCircleIcon as SuccessIcon, ErrorIcon, DeleteIcon, DownloadIcon, PlayArrowIcon as ProcessIcon, UploadFileIcon } from '../../utils/icons';
    ...
    try {
      ...
      switch (file.type) {
        ...
        case 'image':
          result = await aiService.imageOCR(file.file, {
            language: batchsettings.LanguageIcon,
      ...
      if (result.success) {
        ...
        return {
          ...updatedFile,
          status: 'error',
          error: (result as any).error || '处理失败',
          progress: 0
        };
      }
    } catch (error) {
