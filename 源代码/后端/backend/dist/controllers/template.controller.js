...
function initializeTemplates() {
    const sampleTemplates = [
      ...
      `,
            subject: '物理',
            grade: template_model_1.TemplateGradeLevel.MIDDLE,
            difficulty: template_model_1.TemplateDifficultyLevel.BEGINNER,
            duration: 45,
            popularity: 4.7,
            usageCount: 1289,
            author: {
        ...
        },
        {
            ...
            subject: '生物',
            grade: template_model_1.TemplateGradeLevel.MIDDLE,
            difficulty: template_model_1.TemplateDifficultyLevel.INTERMEDIATE,
            duration: 60,
            popularity: 4.5,
            usageCount: 950,
            author: {
        ...
        },
        {
            ...
            subject: '化学',
            grade: template_model_1.TemplateGradeLevel.HIGH,
            difficulty: template_model_1.TemplateDifficultyLevel.ADVANCED,
            duration: 90,
            popularity: 4.8,
            usageCount: 720,
            author: {
        ...
        },
        {
            ...
            subject: '物理',
            grade: template_model_1.TemplateGradeLevel.ELEMENTARY,
            difficulty: template_model_1.TemplateDifficultyLevel.BEGINNER,
            duration: 45,
            popularity: 4.9,
            usageCount: 2150,
...
class TemplateController {
    constructor() {
        ...
        this.createTemplate = (req, res) => {
            try {
                ...
                const completeTemplate = {
                    ...
                    difficulty: newTemplate.difficulty || template_model_1.TemplateDifficultyLevel.BEGINNER,
            ...
            try {
                ...
                const filteredTemplates = allTemplates.filter(template => {
                    ...
                    if (searchParams.search) {
                        ...
                        const textMatch = template.name.toLowerCase().includes(searchLower) ||
                            template.description.toLowerCase().includes(searchLower) ||
                            template.subject.toLowerCase().includes(searchLower) ||
                            template.tags.some(tag => tag.toLowerCase().includes(searchLower));
                        if (!textMatch)
                    ...
                    if (searchParams.tags && searchParams.tags.length > 0) {
                        const hasAllTags = searchParams.tags.every(tag => template.tags.some(t => t.toLowerCase().includes(tag.toLowerCase())));
                        if (!hasAllTags)
                            return false;
                    }
                    // 时长过滤
        ...
        // 获取热门模板
        this.getPopularTemplates = (req, res) => {
            try {
