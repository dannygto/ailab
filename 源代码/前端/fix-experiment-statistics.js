...
console.log('开始修复 ExperimentStatistics.tsx...');

const filePath = path.join(__dirname, 'src/components/domain/experiments/ExperimentStatistics.tsx');
...
try {
  ...
  console.log('✓ ExperimentStatistics.tsx 修复完成');
} catch (error) {
