...
const userService = {
  getUsers: async () => {
    ...
    return new Promise<User[]>((resolve) => {
      setTimeout(() => {
        resolve([
          { id: '1', username: 'admin', email: 'admin@aicam.edu', fullName: 'ϵͳ����Ա', role: 'admin', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 0, 15) },
          { id: '2', username: 'researcher1', email: 'researcher1@aicam.edu', fullName: '�о�Աһ��', role: 'researcher', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 1, 20) },
          { id: '3', username: 'teacher1', email: 'teacher1@aicam.edu', fullName: '��ʦһ��', role: 'teacher', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 2, 10) },
          { id: '4', username: 'student1', email: 'student1@aicam.edu', fullName: 'ѧ��һ��', role: 'student', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 3, 5) },
          { id: '5', username: 'student2', email: 'student2@aicam.edu', fullName: 'ѧ������', role: 'student', status: 'inactive', createdAt: new Date(2023, 3, 15) },
          { id: '6', username: 'guest1', email: 'guest1@example.com', fullName: '�ÿ�һ��', role: 'guest', status: 'pending', createdAt: new Date(2023, 4, 20) },
          { id: '7', username: 'researcher2', email: 'researcher2@aicam.edu', fullName: '�о�Ա����', role: 'researcher', status: 'suspended', lastLogin: new Date(2023, 5, 1), createdAt: new Date(2023, 2, 25) },
          { id: '8', username: 'teacher2', email: 'teacher2@aicam.edu', fullName: '��ʦ����', role: 'teacher', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 1, 15) },
          { id: '9', username: 'student3', email: 'student3@aicam.edu', fullName: 'ѧ������', role: 'student', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 3, 25) },
          { id: '10', username: 'student4', email: 'student4@aicam.edu', fullName: 'ѧ���ĺ�', role: 'student', status: 'active', lastLogin: new Date(), createdAt: new Date(2023, 4, 1) }
        ]);
      }, 800);
    });
  },
    ...
    return new Promise<User>((resolve) => {
      setTimeout(() => {
        resolve({
          ...
          email: userData.EmailIcon|| 'email',
...
const UserManagement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      ...
      result = result.filter(user => 
        ...
        user.EmailIcon.toLowerCase().includes(term) ||
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.EmailIcon) {
      errors.EmailIcon= '���䲻��Ϊ��';
    } else if (!/\S+@\S+\.\S+/.test(formData.EmailIcon)) {
      errors.EmailIcon= '�����ʽ��Ч';
    }
                ...
                filteredUsers
                  ...
                  .map((user) => (
                    <TableRow key={user.id} hover>
                      ...
                      <TableCell>{user.EmailIcon}</TableCell>
                      <TableCell>
          ...
          <Grid container spacing={2} sx={{ mt: 1 }}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                onChange={handleFormChange}
                error={!!formErrors.EmailIcon}
                helperText={formErrors.EmailIcon}
                disabled={formSubmitting}
                required
              />
            </Grid>
